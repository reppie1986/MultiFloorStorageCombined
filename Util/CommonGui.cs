// --------------------------------------------------------------------------------------
// File: CommonGui.cs
// Purpose: Shared GUI utilities for MultiFloorStorage without changing original structure.
// - Label(): Custom label drawer with GUIStyle and UI scaling fix.
// - GetThingTextue(): Returns appropriate icon or portrait texture for things, pawns, corpses.
// - ThingIcon(): Draws thing icon with offsets, transparency, and portrait scaling.
// - ThingIconWorker(): Core drawing method with texture fitting and optional UV cropping.
// --------------------------------------------------------------------------------------
    ...
    static class CommonGUIFunctionsMulti
    {
        ...
        public static Texture GetThingTextue(Rect rect, Thing thing, out Color color)
        {
            ...
            else if (thing is Pawn || thing is Corpse)
            {
                ...
                // Non-humanlike pawns use body graphic
            ...
            {
                // Generic things use resolved graphic
        ...
        public static void ThingIcon(Rect rect, Thing thing, Texture resolvedIcon, Color color, float alpha = 1f)
        {
            ...
            // Icon rotation and offset handling
            if (!thing.def.uiIconPath.NullOrEmpty())
            {
        ...
        // Worker method for icon drawing
